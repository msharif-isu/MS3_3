...
public final class FragmentDashboardBinding implements ViewBinding {
  ...
  @NonNull
  public final Button toGroupsPage;

  private FragmentDashboardBinding(@NonNull ConstraintLayout rootView,
      @NonNull TextView textDashboard, @NonNull Button toGroupsPage) {
    this.rootView = rootView;
    this.textDashboard = textDashboard;
    this.toGroupsPage = toGroupsPage;
  }
  ...
  public static FragmentDashboardBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.to_groups_page;
      Button toGroupsPage = ViewBindings.findChildViewById(rootView, id);
      if (toGroupsPage == null) {
        break missingId;
      }

      return new FragmentDashboardBinding((ConstraintLayout) rootView, textDashboard, toGroupsPage);
    }
