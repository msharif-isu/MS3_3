...
public final class MainActivityBinding implements ViewBinding {
  ...
  private MainActivityBinding(@NonNull ConstraintLayout rootView, @NonNull TextView email,
  ...
  public static MainActivityBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new MainActivityBinding((ConstraintLayout) rootView, email, username);
    }
